...
<select id="drinks1Type" name="data[Order][subtotal]" onchange="calculate()">
  ...
  <optgroup label="Choose Subscription">
    <option value="24776.46">3 months</option>6999
 <option value="46012.92">6 months</option>6499
 <option value="87777.84">12 months</option>6199
  </optgroup>
...
function calculate() {
        ...
        switch (myBox2) {
            case '24776.46':
                inputCost="<td>Subtotal : 6999 * 3 months </td><td><i class='fa fa-inr'></i> "+6999*3+"</td>";
                inputTax="<td>Taxes & Fees :</td> <td><i class='fa fa-inr'></i>3779.46</td>";
                inputTotal="<td>Total :</td> <td><i class='fa fa-inr'></i>24776.46</td>";
                break
        case '46012.92':
               inputCost="<td>Subtotal : 6499 * 6 months</td> <td><i class='fa fa-inr'></i> "+6499*6+"</td>";
                inputTax="<td>Taxes & Fees : </td><td><i class='fa fa-inr'></i>7018.92</td>";
                inputTotal="<td>Total : </td><td><i class='fa fa-inr'></i>46012.92</td>";
                break
        case '87777.84':
               inputCost="<td>Subtotal : 6199 * 12 months </td><td><i class='fa fa-inr'></i> "+6199*12+"</td>";
                inputTax="<td>Taxes & Fees : </td><td><i class='fa fa-inr'></i>13389.84</td>";
                inputTotal="<td>Total : </td><td><i class='fa fa-inr'></i>87777.84</td>";
                break
            //default:
...
<table>
      <tr class="totals-value" id="result"><td>Subtotal :&nbsp;</td><td><i class="fa fa-inr"></i>&nbsp;74388.00</td></tr>
      <tr class="totals-value" id="tax"><td>Taxes & Fees :&nbsp;</td><td><i class="fa fa-inr"></i>&nbsp;13389.84</td></tr>
   
      <tr class="totals-value" id="total"><td>Total :&nbsp;</td><td><i class="fa fa-inr"></i>&nbsp;87777.84</td></tr>
      </table>
<br>
...
<input type="hidden" id="CHANNEL_ID" tabindex="4" maxlength="12" size="12" name="data[Order][CHANNEL_ID]" autocomplete="off" value="WEB">
						...
						<input type="hidden" name="data[Order][order_type]" value="Ecommerce Plan">
