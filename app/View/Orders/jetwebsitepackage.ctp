...
<select id="drinks1Type" name="data[Order][subtotal]" onchange="calculate()">
  ...
  <optgroup label="Choose Subscription">
    <option value="10616.46">3 months</option>2999
 <option value="17692.92">6 months</option>2499
 <option value="32553.84">12 months</option>2299
  </optgroup>
</select>
<br>
<script>
function calculate() {
        ...
        switch (myBox2) {
            case '10616.46':
                inputCost="<td>Subtotal : 2999 * 3 months </td><td><i class='fa fa-inr'></i> "+2999*3+"</td>";
                inputTax="<td>Taxes & Fees :</td> <td><i class='fa fa-inr'></i>1619.46</td>";
                inputTotal="<td>Total :</td> <td><i class='fa fa-inr'></i>10616.46</td>";
                break
        case '17692.92':
               inputCost="<td>Subtotal : 2499 * 6 months</td> <td><i class='fa fa-inr'></i> "+2499*6+"</td>";
                inputTax="<td>Taxes & Fees : </td><td><i class='fa fa-inr'></i>2698.92</td>";
                inputTotal="<td>Total : </td><td><i class='fa fa-inr'></i>17692.92</td>";
                break
        case '32553.84':
               inputCost="<td>Subtotal : 2299 * 12 months </td><td><i class='fa fa-inr'></i> "+2299*12+"</td>";
                inputTax="<td>Taxes & Fees : </td><td><i class='fa fa-inr'></i>4965.84</td>";
                inputTotal="<td>Total : </td><td><i class='fa fa-inr'></i>32553.84</td>";
                break
            //default:
...
<table>
      <tr class="totals-value" id="result"><td>Subtotal :&nbsp;</td><td><i class="fa fa-inr"></i>&nbsp;27588.00</td></tr>
      <tr class="totals-value" id="tax"><td>Taxes & Fees :&nbsp;</td><td><i class="fa fa-inr"></i>&nbsp;4965.84</td></tr>
      <tr class="totals-value" id="total"><td>Total :&nbsp;</td><td><i class="fa fa-inr"></i>&nbsp;32553.84</td></tr>
      </table>
<br>
...
<input type="hidden" name="data[Order][product_id]"  value="2">			
<!-- CHECKBOX -->			
					<!-- CHECKBOX -->
...
<input type="hidden" name="data[Order][order_type]" value="Jet Plan">
