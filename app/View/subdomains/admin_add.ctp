...
<div class="col-sm-4">
<?php echo $this->Form->input('parentcategories', array('name' => 'data[Subdomain][category_id]', 'class'=>'form-control col-md-3 ddStatus','label'=>'','empty' => false));?>	
</div>
</div>
			 <div class="form-group">
...
<div class="col-sm-8" id="subcategorieslist">  			 
 <?php foreach ($categories as $category):?>
              ...
              <label class="checkbox col-sm-4"><input type="checkbox" value="<?php echo h($category['Category']['id']); ?>">
