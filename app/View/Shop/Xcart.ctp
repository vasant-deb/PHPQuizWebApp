...
<?php foreach ($shop['OrderItem'] as $key => $item): ?>
    ...
    <div class="row" id="row-<?php echo $key; ?>">
        <div class="col col-sm-1"><?php echo $this->Html->image('/images/small/' . $item['Product']['image'], ['class' => 'px60']); ?></div>
        <div class="col col-sm-7">
            <strong><?php echo $this->Html->link($item['Product']['name'], ['controller' => 'products', 'action' => 'view', 'slug' => $item['Product']['slug']]); ?></strong>
            <?php
            $mods = 0;
        ...
        <div class="col col-sm-1"><?php echo $this->Form->input('quantity-' . $key, ['div' => false, 'type' => 'tel', 'class' => 'numeric form-control input-small', 'label' => false, 'size' => 2, 'maxlength' => 2, 'tabindex' => $tabindex++, 'data-id' => $item['Product']['id'], 'data-mods' => $mods, 'value' => $item['quantity']]); ?></div>
...
<div class="row">
    <div class="col col-sm-12">
        ...
        <?php echo $this->Html->link('<i class="fa fa-ban"></i> &nbsp; Clear Shopping Cart', ['controller' => 'shop', 'action' => 'clear'], ['class' => 'btn btn-sm btn-danger', 'escape' => false]); ?>
        &nbsp; &nbsp;
        <?php echo $this->Form->button('<i class="fa fa-calculator"></i> &nbsp; Update', ['class' => 'btn btn-sm btn-default', 'escape' => false]);?>
...
<div class="row">
    <div class="col col-sm-12 pull-right tr">
        ...
        <?php echo $this->Html->link('<i class="fa fa-check"></i> &nbsp; Checkout', ['controller' => 'shop', 'action' => 'address'], ['class' => 'btn btn-sm btn-success', 'escape' => false]); ?>

        <br />
        <br />

        <?php echo $this->Form->create(NULL, ['url' => ['controller' => 'shop', 'action' => 'step1']]); ?>
