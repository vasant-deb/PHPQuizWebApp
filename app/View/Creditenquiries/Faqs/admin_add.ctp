        ...
        <div class="widget-container fluid-height clearfix">
          ...
          ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Faq][name]" maxlength="255" type="text" class="form-control" id="BannerName">
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Faq][description]" maxlength="255" type="text" class="form-control" id="BannerName">
