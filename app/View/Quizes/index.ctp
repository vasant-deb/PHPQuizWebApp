...
<?php } ?>
		...
		<?php foreach($reports as $report):?>
            <tr>
			    <td><?php echo $report['Report']['quiz_id'];?></td>
                <td><?php echo $report['Report']['quiz_title'];?></td>
                <td><?php echo $report['Report']['marks'];?></td>
				<td><?php  echo $report['Report']['time'];?></td>
				
				<td><a href="<?php echo $report['Report']['certi'];?>" download>download</a></td>
