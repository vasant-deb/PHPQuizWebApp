...
<label for="site_name" class="col-sm-2 control-label">Select Product</label>
<div class="col-sm-4">
<?php echo $this->Form->input('parentcategories', array('name' => 'data[Catalog][category_id]', 'value' => $this->data['Catalog']['category_id'],  'class'=>'form-control col-md-3 ddStatus','label'=>'','empty' => false));?>	
</div>
</div>
--> 
