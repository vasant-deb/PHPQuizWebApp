...
<div class="container-fluid main-content">
    ...
    <div class="form-group">
		...
		<?php echo $this->Form->input('description', array('class' => 'ckeditor' ,'label'=>'')); ?>
                ...
                <div class="col-md-7">
 				  <?php echo $this->Form->input('meta_title', array('class'=>'form-control','label'=>'' , 'onkeyup'=>'countChar(this)'));?>	
                ...
                <div class="col-md-7"> 				 
 				  <?php echo $this->Form->input('meta_desc', array('class'=>'form-control','label'=>'','onkeyup'=>'countMetas(this)'));?>
