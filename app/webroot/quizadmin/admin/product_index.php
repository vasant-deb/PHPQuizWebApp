                    ...
                    <div class="row row-cards">
                       ...
                       <div class="col-12">
                            ...
                            Products
                                    ...
                                    <a href="product_add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Product</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table card-table table-vcenter text-nowrap datatable">
                                        ...
                                        <tbody>
										<?php
$smwr=mysqli_query($con,"select * from products");
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo  $name;?></td>
                                                <td>
                                                    <img src="../images/products/<?php echo $image;?>" width="100px" height="70px" alt="<?php echo $heading;?>" title="<?php echo $heading;?>">  
                                                </td>
                                                ...
                                                <td>
                                                    <a class="icon" href="product_view.php?con=<?= $id;?>">
