...
$smwr=mysqli_query($con,"select * from categories where id='$_GET[con]'");
  ...
  if(isset($_POST['update']))
{
	$name=$_POST['name'];
		...
		$update1=mysqli_query($con,"UPDATE categories SET name='$name' WHERE id='$_GET[con]'");	
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" value="<?=$name;?>" placeholder="Text..">
                                            </div>
