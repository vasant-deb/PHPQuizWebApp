...
$smwr=mysqli_query($con,"select * from subcategories where id='$_GET[con]'");
  ...
  if(isset($_POST['update']))
{
	...
	$name=$_POST['name'];
		...
		$update1=mysqli_query($con,"UPDATE subcategories SET category_id='$category_id',name='$name'");	
	}
 header('location:subcategories_index.php');
