...
$smwr=mysqli_query($con,"select * from products where id='$_GET[con]'");
  ...
  if(isset($_POST['update']))
{
   ...
   $update=mysqli_query($con,"UPDATE products SET image='$attach1',name='$name',category='$category',subcategory='$subcategory',short_description='$short_description',description='$description',price='$price' WHERE id='$_GET[con]'");
	
	}
	else{
		
		$attach1=$image;
		$update1=mysqli_query($con,"UPDATE products SET image='$attach1',name='$name',category='$category',subcategory='$subcategory',short_description='$short_description',description='$description',price='$price' WHERE id='$_GET[con]'");	
	}
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?=$name;?>" name="name"  placeholder="Text..">
                                            </div>
                                            <div class="form-group">
            ...
            ?>
											 ...
											 <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <input type="file" value="<?=$image;?>" class="custom-file-input" name="attachment">
									   ...
									   <div class="col-md-4 col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price" value="<?=$price;?>" id="basic-url" aria-describedby="basic-addon3">
                                                </div>
                                            </div>
