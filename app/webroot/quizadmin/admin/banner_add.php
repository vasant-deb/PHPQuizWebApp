                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="heading"  placeholder="Text..">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="button1_text"  id="basic-url" aria-describedby="basic-addon3">
                                                </div>
                                            </div>
                                           <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="basic-url" name="button2_text"   aria-describedby="basic-addon3">
                                                </div>
                                            </div>
									   ...
									   <div class="col-md-4 col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="button1_url"  id="basic-url" aria-describedby="basic-addon3">
                                                </div>
                                            </div>
                                           <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="basic-url" name="button2_url" aria-describedby="basic-addon3">
                                                </div>
                                            </div>
									   </div>
                                    </div>
