                    ...
                    <div class="row row-cards">
                       ...
                       <div class="col-12">
                            ...
                            Categories
                                    ...
                                    <a href="categories_add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</a>
									 <a href="subcategories_add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Subcategory</a>
                                </div>
...
?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="icon" href="categories.php?con=<?= $id;?>">
