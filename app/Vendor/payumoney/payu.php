...
class Payu {
    ...
    private $merchantKey = "3a7U591e";
    // Merchant Salt as provided by Payu
    private $salt = "Poono1dhFy";
    // End point - change to https://secure.payu.in for LIVE mode
    private $payuBaseURL = "https://test.payu.in";
    //Hash code
    private $hash = "";

    //Constructor
    public function __construct($merchantKey = "3a7U591e", $salt = "Poono1dhFy", $sandbox = true) {
